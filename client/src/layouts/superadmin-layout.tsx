...
import { Loader2, Building2, LayoutDashboard, Users, LogOut, Shield, UserCog, MessageSquare, Mail } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const menuItems = [
  ...
  { title: "Email Settings", url: "/superadmin/email-settings", icon: Mail },
];
